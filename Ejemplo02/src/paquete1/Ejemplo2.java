...
public class Ejemplo2 {
    ...
    public static void main(String[] args) {
        ...
        entrada.nextLine(); // limpieza de buffer // Necesitamos realizar una 
        // limpieza de buffer para poder ingresar de nuevo un valor tipo cadena 
        // despues de haber ingresado un valor tipo decimal
